...
class TournamentMatch(db.Model):
    ...
    completed_at = db, nullable=True)
.Column(db.DateTime    next_match_id = db.Column(db.String(50), nullable=True)  # ID of the match this winner advances to
    ...
    next_match = db.relationship('TournamentMatch', remote_side=[id])
