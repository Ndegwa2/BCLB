...
export function GameCard({ game, onJoin, onSpectate, isJoining, currentUserId }: GameCardProps) {
          ...
          >
            {isJoining ? (
              ...
              <>
                ...
                Join Game (${game.stakeAmount.toFixed(2)})
              </>
            )}
          </Button>
        );
    ...
    >
      ...
      <div className="flex items-center justify-center gap-4 my-4 py-3 rounded-lg bg-white/5">
        <div className="flex items-center gap-1.5 text-sm text-white/80">
          ...
          <span>Stake: <span className="font-semibold text-white">${game.stakeAmount.toFixed(2)}</span></span>
        </div>
        <span className="text-white/20">•</span>
        <div className="flex items-center gap-1.5 text-sm">
          <span className="gradient-text-green font-semibold">🏆 Pot: ${game.totalPot.toFixed(2)}</span>
        </div>
      </div>
