...
const presetStakes = [10, 25, 50, 100];
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              <input
                ...
                style={{
                  background: `linear-gradient(to right, #9333ea 0%, #ec4899 ${((stakeAmount - 1) / (Math.min(500, userBalance) - 1)) * 100}%, rgba(255,255,255,0.1) ${((stakeAmount - 1) / (Math.min(500, userBalance) - 1)) * 100}%)`
                }}
              />
              <div className="flex items-center justify-between text-sm">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <input
                    type="number"
                    value={stakeAmount}
                    onChange={(e) => setStakeAmount(Math.max(1, Math.min(Number(e.target.value), userBalance)))}
          ...
          <div className="p-4 bg-blue-500/10 border border-blue-500/20 rounded-lg">
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <p className="text-lg font-bold gradient-text-green">${totalPot.toFixed(2)}</p>
              </div>
              <div>
                <p className="text-xs text-white/60">Platform Fee (5%)</p>
                <p className="text-lg font-bold text-white/80">${platformFee.toFixed(2)}</p>
              </div>
            </div>
          </div>
          ...
          >
            {isCreating ? (
              ...
              <>
                ...
                Create Game - ${stakeAmount.toFixed(2)}
              </>
            )}
          </Button>
        </div>
