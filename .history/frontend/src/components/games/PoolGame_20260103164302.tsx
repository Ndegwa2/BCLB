...
class PoolGameScene extends Phaser.Scene {
  ...
  private createPockets() {
    ...
    // Corner pocket radius (r="22" in SVG scaled to canvas)
    const cornerPocketRadius = 22 * (w / 900);
    // Side pocket radius (r="18" in SVG scaled to canvas)
    const sidePocketRadius = 18 * (w / 900);

    // Pocket positions matching SVG coordinates (scaled to canvas)
    const pocketPositions = [
      // Corner pockets (r=22)
      { x: w * (60 / 900), y: h * (60 / 500), radius: cornerPocketRadius },   // Top left
      { x: w * (840 / 900), y: h * (60 / 500), radius: cornerPocketRadius },  // Top right
      { x: w * (60 / 900), y: h * (440 / 500), radius: cornerPocketRadius },  // Bottom left
      { x: w * (840 / 900), y: h * (440 / 500), radius: cornerPocketRadius }, // Bottom right
      // Side pockets (r=18)
      { x: w * (450 / 900), y: h * (60 / 500), radius: sidePocketRadius },    // Top center
      { x: w * (450 / 900), y: h * (440 / 500), radius: sidePocketRadius }    // Bottom center
    ];
    ...
    console.log('Pockets created matching SVG design');
  }
