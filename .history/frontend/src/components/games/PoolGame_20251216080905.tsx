...
class PoolGameScene extends Phaser.Scene {
  ...
  private createBalls() {
    ...
    const ballTypes = [
      { key: 'solid1', type: 'solid', number: 1, color: 0x0000FF }, // Blue (solid)
      { key: 'solid2', type: 'solid', number: 2, color: 0x0000FF }, // Blue (solid)
      { key: 'solid3', type: 'solid', number: 3, color: 0x0000FF }, // Blue (solid)
      { key: 'solid4', type: 'solid', number: 4, color: 0x0000FF }, // Blue (solid)
      { key: 'solid5', type: 'solid', number: 5, color: 0x0000FF }, // Blue (solid)
      { key: 'solid6', type: 'solid', number: 6, color: 0x0000FF }, // Blue (solid)
      { key: 'solid7', type: 'solid', number: 7, color: 0x0000FF }, // Blue (solid)
      { key: 'stripe9', type: 'stripe', number: 9, color: 0x00FF00 }, // Green (stripe)
      { key: 'stripe10', type: 'stripe', number: 10, color: 0x00FF00 }, // Green (stripe)
      { key: 'stripe11', type: 'stripe', number: 11, color: 0x00FF00 }, // Green (stripe)
      { key: 'stripe12', type: 'stripe', number: 12, color: 0x00FF00 }, // Green (stripe)
      { key: 'stripe13', type: 'stripe', number: 13, color: 0x00FF00 }, // Green (stripe)
      { key: 'stripe14', type: 'stripe', number: 14, color: 0x00FF00 }, // Green (stripe)
      { key: 'stripe15', type: 'stripe', number: 15, color: 0x00FF00 }, // Green (stripe)
