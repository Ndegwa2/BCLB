  ...
  return (
    <div className="min-h-screen bg-green-800 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 right-0 z-10 bg-green-900 bg-opacity-90 p-4">
        <h2 className="text-white text-xl font-bold">9 Ball Pool - {currentGame.game_code}</h2>
...
class PoolGameScene extends Phaser.Scene {
  ...
  private createBalls() {
    ...
    const ballTypes = [
      { key: 'ball1', type: 'nineball', number: 1, color: 0xFFFF00 }, // Yellow
      { key: 'ball2', type: 'nineball', number: 2, color: 0x0000FF }, // Blue
      { key: 'ball3', type: 'nineball', number: 3, color: 0xFF0000 }, // Red
      { key: 'ball4', type: 'nineball', number: 4, color: 0xFF00FF }, // Purple
      { key: 'ball5', type: 'nineball', number: 5, color: 0xFF8800 }, // Orange
      { key: 'ball6', type: 'nineball', number: 6, color: 0x00FFFF }, // Cyan
      { key: 'ball7', type: 'nineball', number: 7, color: 0x8800FF }, // Dark Purple
      { key: 'ball8', type: 'nineball', number: 8, color: 0x000000 }, // Black
      { key: 'ball9', type: 'nineball', number: 9, color: 0xFFFF00 }, // Yellow (9-ball)
    ];
