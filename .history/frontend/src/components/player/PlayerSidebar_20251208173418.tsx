...
const PlayerSidebar: React.FC<PlayerSidebarProps> = ({ className = '' }) => {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      icon: (
        <>
          <path d="M16 30h20M26 20v20" stroke="#9fb9ff" strokeWidth="2" strokeLinecap="round" />
        </>
      )
    },
    {
      ...
      path: '/tournaments',
      icon: (
        <path d="M16 28h20" stroke="#9fb9ff" strokeWidth="2" strokeLinecap="round" />
      )
    },
    {
      id: 'wallet',
    ...
    },
    {
      ...
      icon: (
        <>
          <path d="M18 20h16M18 32h16" stroke="#9fb9ff" strokeWidth="2" strokeLinecap="round" />
        </>
      )
    }
  ]
