        ...
        const mockTournaments: Tournament[] = [
          {
            ...
            entries: Array(12).fill(null).map((_, i) => ({ id: i + 1, user_id: i + 1, tournament_id: 1, joined_at: new Date().toISOString(), status: 'active', created_at: new Date().toISOString(), updated_at: new Date().toISOString' }))
          },
          {
            id: 2,
            ...
            updated_at: new Date().toISOString(),
            entries: Array(8).fill(null).map((_, i) => ({ id: i + 13, user_id: i + 13, tournament_id: 2, joined_at: new Date().toISOString(), status: 'active', created_at: new Date().toISOString(), updated_at: new Date().toISOString' }))
          },
          {
            id: 3,
            ...
            updated_at: new Date().toISOString(),
            entries: Array(3).fill(null).map((_, i) => ({ id: i + 21, user_id: i + 21, tournament_id: 3, joined_at: new Date().toISOString(), status: 'active', created_at: new Date().toISOString(), updated_at: new Date().toISOString' }))
          },
          {
            id: 4,
            ...
            updated_at: new Date().toISOString(),
            entries: Array(2).fill(null).map((_, i) => ({ id: i + 24, user_id: i + 24, tournament_id: 4, joined_at: new Date().toISOString(), status: 'active', created_at: new Date().toISOString(), updated_at: new Date().toISOString' }))
          }
        ]
