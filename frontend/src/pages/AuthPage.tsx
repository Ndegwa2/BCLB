...
const AuthPage: React.FC = () => {
  ...
  }, [state.isAuthenticated, state.isLoading, state.user?.is_admin, navigate])
  ...
  }, [location.pathname, mode, loginForm, signupForm])
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          {...signupForm.register('phone_number', {
                            ...
                            pattern: { value: /^\+?1?\d{9,15}$/, message: 'Phone number must be 9-15 digits (optional + prefix)' }
                          })}
                        />
                      </div>
