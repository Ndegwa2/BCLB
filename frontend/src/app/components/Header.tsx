...
const navTabs = [
  { id: "lobby", label: "Lobby", path: "/dashboard" },
  { id: "tournaments", label: "Tournaments", path: "/tournaments" },
  { id: "my-games", label: "My Games", path: "/games" },
  { id: "leaderboard", label: "Leaderboard", path: "/play-vs-ai" },
];
...
export function Header({
  ...
  void _onMenuClick; // Used in mobile menu
          ...
          <div className="flex items-center gap-2">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-56 bg-slate-900 border-white/10">
                ...
                <DropdownMenuItem onClick={() => navigate('/profile')} className="text-white/80 hover:text-white hover:bg-white/10 cursor-pointer">
